            ...
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="my-5 text-center text-xl-start">
                        <h1 class="display-7 fw-bolder text-success mb-2 justify-content-center">Revisi Telah Disetujui</h1>
                        <a href="http://localhost:8080/berkas/index" class=" btn btn-warning">Kembali</a>
    </header>
