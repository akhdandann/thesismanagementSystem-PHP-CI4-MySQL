...
<head>
    ...
    <title>Check Revisi Tugas Akhir</title>
    <!-- Favicon-->
    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <a class="navbar-brand" href="index.html">Check Revisi Tugas Akhir Departemen Sistem Informasi</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link" href="http://localhost:8080/index.php/admin/home">Home</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                <li><a class="dropdown-item" href="blog-home.html">Daftar Mahasiswa</a></li>
                                <li><a class="dropdown-item" href="blog-post.html">Check Revisi</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownPortfolio">
                                ...
                                <li><a class="dropdown-item" href="http://localhost:8080/index.php/admin/login">Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-info" href="<?= base_url(); ?>/berkas/download/<?= $row->id_berkas; ?>">Download</a>
                                        <a class="btn btn-success" href="http://localhost:8080/admin/setuju">Setuju</a>
                                        <a class="btn btn-danger" href="<?= base_url(); ?>/berkas/download/<?= $row->id_berkas; ?>">Tolak</a>
                                    </td>
                                </tr>
                            <?php
                            }
