    ...
    public function login()
    {
        ...
        if (get_cookie('cookie_username') && get_cookie('cookie_password')) {
            ...
            /*$akun = [
                ...
                'akun_nama_lengkap' => $dataAkun['namalengkap'],
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if (!password_verify($password, $dataAkun['password'])) {
                $err[] = "Username dan password yang anda masukkan tidak sesuai!";
                session()->setFlashdata('username', $username);
                session()->setFlashdata('warning', $err);
                return redirect()->to("admin/login");
            }
            ...
            session()->set($akun);
            return redirect()->to("admin/home")->withCookies();
        }
